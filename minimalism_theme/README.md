...
A shadcn/ui-inspired backend theme for self-hosted Odoo 18 Community by RivetFox. Light zinc surfaces, rounded controls and fine borders, with a complete personal dark mode.
...
This checkout supports Odoo 18. Separate `16.0`, `17.0`, `18.0` and `19.0` branches are available at https://github.com/Welgum/odoo-minimalism-theme. Install the matching branch.
