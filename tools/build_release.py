...
def validate():
    ...
    require(re.fullmatch(r"17\.0\.\d+\.\d+\.\d+", manifest["version"]), "Expected an Odoo 17 five-part version")
        ...
        for filename in bundle:
            if isinstance(filename, tuple):
                ...
                if len(directive) == 2 and directive[0] == "include":
                    require(directive[1] in {'web.assets_web_dark'}, f"Review included bundle: {directive}")
                    continue
